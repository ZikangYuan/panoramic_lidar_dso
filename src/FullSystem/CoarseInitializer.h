...
public:
	...
	*/
	Pnt* points[CAM_NUM][PYR_LEVELS]; 		//!< 每一层上的点类, 是第一帧提取出来的
	int numPoints[CAM_NUM][PYR_LEVELS];  	//!< 每一层的点数目
...
private:
	...
	*/
	Mat33 K[CAM_NUM][PYR_LEVELS];			//!< camera参数
	Mat33 Ki[CAM_NUM][PYR_LEVELS];
	double fx[CAM_NUM][PYR_LEVELS];
	double fy[CAM_NUM][PYR_LEVELS];
	double fxi[CAM_NUM][PYR_LEVELS];
	double fyi[CAM_NUM][PYR_LEVELS];
	double cx[CAM_NUM][PYR_LEVELS];
	double cy[CAM_NUM][PYR_LEVELS];
	double cxi[CAM_NUM][PYR_LEVELS];
	double cyi[CAM_NUM][PYR_LEVELS];
