...
// 2021.11.13
int setting_margin = 4;

const std::string pointCloudTopic = "/nclt/velo/point_cloud";

// const std::string ImgTopic1 = "/nclt/image_cam5";
// const std::string ImgTopic2 = "/nclt/image_cam4";
// const std::string ImgTopic3 = "/nclt/image_cam3";
// const std::string ImgTopic4 = "/nclt/image_cam2";
// const std::string ImgTopic5 = "/nclt/image_cam1";

// const std::string ImgTopic1 = "/image_cam1";
// const std::string ImgTopic2 = "/image_cam2";
// const std::string ImgTopic3 = "/image_cam3";
// const std::string ImgTopic4 = "/image_cam4";
// const std::string ImgTopic5 = "/image_cam5";

// const std::string pointCloudTopic1 = "/IJRP/velo/pointcloud1";
// const std::string pointCloudTopic2 = "/IJRP/velo/pointcloud2";
// const std::string pointCloudTopic3 = "/IJRP/velo/pointcloud3";
// const std::string pointCloudTopic4 = "/IJRP/velo/pointcloud4";
// const std::string pointCloudTopic5 = "/IJRP/velo/pointcloud5";
...
int cam_idx_array[5] = {5,4,3,2,1};
// int cam_idx_array[5] = {1,2,3,4,5};
int idx_use[5] = {0,1,2,3,4};
// int idx_use[1] = {0};
int cam_num = CAM_NUM;
int m_binFraction=1;
int m_numBins = 256/m_binFraction;
bool setting_useNCLT = true;
bool setting_optDepth = false;
bool setting_useKFselection = false;
bool setting_useMultualP = false;
bool setting_useMultualPBack = false;
bool setting_resManyBlock = false;
int estimateType = 0;
float setting_weightMotion = 0;
float setting_mulPweight = 1;


/* Parameters when KF's are taken */
...
float setting_maxShiftWeightT= 0.04f * /*(640+480)*/(1616+1232); // TODO
float setting_maxShiftWeightR= 0.0f * /*(640+480)*/(1616+1232);
float setting_maxShiftWeightRT= 0.02f * /*(640+480)*/(1616+1232);
...
// TODO maybe increasing this can increase accuracy
float setting_desiredImmatureDensity = 800/*1500*/; // immature points per frame
float setting_desiredPointDensity = 1500/*2000*/; // aimed total points in the active window.
float setting_minPointsRemaining = 0.05/*0.05*/;  // marg a frame if less than X% points remain. TODO
...
int   setting_minFrames = 5; // min frames in window. 5
int   setting_maxFrames = 7; // max frames in window. 7
...
float setting_minGradHistAdd = 7/*7*/;
