...
extern bool setting_useNCLT;
extern bool setting_optDepth;
extern bool setting_useKFselection;
extern int estimateType;
extern float setting_mulPweight;
extern float setting_weightMotion;

extern const std::string pointCloudTopic;
extern const std::string pointCloudTopic1;
extern const std::string pointCloudTopic2;
extern const std::string pointCloudTopic3;
extern const std::string pointCloudTopic4;
extern const std::string pointCloudTopic5;
extern const std::string ImgTopic1;
extern const std::string ImgTopic2;
extern const std::string ImgTopic3;
extern const std::string ImgTopic4;
extern const std::string ImgTopic5;
extern int setting_margin;
...
extern int cam_num;
extern int m_binFraction;
extern int m_numBins;
extern int cam_idx_array[5];
extern int idx_use[5];
// extern int idx_use[1];
extern bool setting_useMultualP;
extern bool setting_useMultualPBack;
extern bool setting_resManyBlock;
